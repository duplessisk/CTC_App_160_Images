        ...
        "<div class='new-image-row'> "+ 
            "<div class='checkboxes-container'>" + 
                "<div class='checkbox-container'>" + 
                    "<label for='myRadioIdYes"+(i-5)+"' class='radio-button-labels'>" + 
                        "<input type='radio' value='yes' name='radio"+(i-5)+"' class='default-radio-buttons yes_check_boxes' id='myRadioIdYes"+(i-5)+"'>" + 
                ...
                "<div id='buffer'></div>" + 
                "<div class='checkbox-container'>" + 
                "<label for='myRadioIdNo"+(i-5)+"' class='radio-button-labels'>" + 
                    "<input type='radio' value='no' name='radio"+(i-5)+"' class='default-radio-buttons no_check_boxes' id='myRadioIdNo"+(i-5)+"'>" + 
                    "<div class='custom-radio-buttons'></div>" + 
                    "Not-CTC" + 
                "</label>" +
            "</div>" + 
