        ...
        "<div class='new-image-row'> "+ 
            ...
            "</div>" + 
                ...
                "<div class= 'cell-image-row-container'>" + 
                    "<img src='/static/object_images/object" + imageNumHundredths + imageNumTens + i +".png' alt='This image was originally intended to display a row of cell images' id='cellImage'>" + 
                "</div>" + 
            "</div>" + 
        "</div>"
}